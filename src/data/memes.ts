...
export const memes: Meme[] = [
  ...
  {
    src: "/memes/engineer/communication.PNG",
    alt: "communication",
    category: "engineer",
  },
  ...
  { src: "/memes/job/six.JPG", alt: "six", category: "job" },
  // product
  { src: "/memes/product/product.JPG", alt: "product", category: "product" },
  {
    src: "/memes/product/requirements.JPG",
    alt: "requirements",
    category: "product",
  },
  // other
  { src: "/memes/other/card.JPG", alt: "card", category: "other" },
];
